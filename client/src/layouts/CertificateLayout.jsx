...
import CertificateNavigation from "../components/navigation/CertificateNavigation.jsx";
import MobileModuleNavigation from "../components/navigation/MobileModuleNavigation.jsx";
import Footer from "../components/Footer.jsx";

function CertificateLayout() {
  return (
    <div className="min-h-screen bg-transparent text-slate-900 flex flex-col justify-between selection:bg-blue-500 selection:text-white">
      ...
      <div className="mx-auto flex w-full max-w-[1600px] flex-1 flex-col px-4 py-4 sm:px-6 lg:px-8">
        ...
        <MobileModuleNavigation module="certificate" />
